...
"""autogenerated by genpy from msg_generate/serial_msg.msg. Do not edit."""
import codecs
import sys
...
class serial_msg(genpy.Message):
  _md5sum = "fbc3cf6a4f8860d2007547b0553a4524"
  _type = "msg_generate/serial_msg"
...
char Motion_Num
"""
  __slots__ = ['length','mode','id','speed','position','type','acceleration','Motion_Mode','Motion_Num']
  _slot_types = ['int32','int32','int32[]','int32[]','int32[]','int32[]','int32[]','int32','char']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       length,mode,id,speed,position,type,acceleration,Motion_Mode,Motion_Num
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_iB().pack(_x.Motion_Mode, _x.Motion_Num))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.Motion_Mode, _x.Motion_Num,) = _get_struct_iB().unpack(str[start:end])
      return self
