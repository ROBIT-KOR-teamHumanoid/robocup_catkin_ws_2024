...
if("TRUE" STREQUAL "TRUE")
  set(load_cell_SOURCE_PREFIX /home/robit/catkin_ws/src/load_cell)
  set(load_cell_DEVEL_PREFIX /home/robit/catkin_ws/devel)
  ...
  set(load_cell_INSTALL_PREFIX /home/robit/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'load_cell' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'load_cell' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robit/catkin_ws/src/load_cell/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT load_cell_NUM_DUMMY_TARGETS)
      set(load_cell_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::load_cell::wrapped-linker-option${load_cell_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR load_cell_NUM_DUMMY_TARGETS "${load_cell_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::load_cell::wrapped-linker-option${load_cell_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND load_cell_LIBRARIES "${interface_target_name}")
...
set(load_cell_EXPORTED_TARGETS "load_cell_generate_messages_cpp;load_cell_generate_messages_eus;load_cell_generate_messages_lisp;load_cell_generate_messages_nodejs;load_cell_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${load_cell_dep}_FOUND)
      find_package(${load_cell_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${load_cell_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
...
set(pkg_cfg_extras "load_cell-msg-extras.cmake")
