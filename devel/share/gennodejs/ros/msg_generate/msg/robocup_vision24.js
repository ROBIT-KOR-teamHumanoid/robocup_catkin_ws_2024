...
class robocup_vision24 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robocup_vision24(null);
  ...
  static datatype() {
    ...
    return 'msg_generate/robocup_vision24';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new robocup_vision24(null);
...
module.exports = robocup_vision24;
