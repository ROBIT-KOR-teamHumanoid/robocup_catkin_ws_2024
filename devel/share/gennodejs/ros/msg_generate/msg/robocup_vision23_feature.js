...
class robocup_vision23_feature {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robocup_vision23_feature(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robocup_vision23_feature(null);
...
module.exports = robocup_vision23_feature;
