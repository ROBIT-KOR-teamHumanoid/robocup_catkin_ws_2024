...
class udp_msg_TC_Kicker {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new udp_msg_TC_Kicker(null);
  ...
  static datatype() {
    ...
    return 'msg_generate/udp_msg_TC_Kicker';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new udp_msg_TC_Kicker(null);
...
module.exports = udp_msg_TC_Kicker;
