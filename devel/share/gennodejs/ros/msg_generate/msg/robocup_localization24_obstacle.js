...
class robocup_localization24_obstacle {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robocup_localization24_obstacle(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robocup_localization24_obstacle(null);
...
module.exports = robocup_localization24_obstacle;
