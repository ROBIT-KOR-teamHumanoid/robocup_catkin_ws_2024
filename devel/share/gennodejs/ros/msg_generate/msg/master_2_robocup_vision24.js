...
class master_2_robocup_vision24 {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new master_2_robocup_vision24(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new master_2_robocup_vision24(null);
...
module.exports = master_2_robocup_vision24;
