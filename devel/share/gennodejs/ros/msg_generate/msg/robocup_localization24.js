...
class robocup_localization24 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robocup_localization24(null);
  ...
  static datatype() {
    ...
    return 'msg_generate/robocup_localization24';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new robocup_localization24(null);
...
module.exports = robocup_localization24;
