...
;//! \htmlinclude udp_kicker_msg.msg.html

(cl:defclass <udp_kicker_msg> (roslisp-msg-protocol:ros-message)
  ((robot_num
    :reader robot_num
    :initarg :robot_num
    :type cl:integer
...
(cl:defclass udp_kicker_msg (<udp_kicker_msg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <udp_kicker_msg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'udp_kicker_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_generate-msg:<udp_kicker_msg> is deprecated: use msg_generate-msg:udp_kicker_msg instead.")))

(cl:ensure-generic-function 'robot_num-val :lambda-list '(m))
(cl:defmethod robot_num-val ((m <udp_kicker_msg>))
...
(cl:defmethod robot_case-val ((m <udp_kicker_msg>))
...
(cl:defmethod local_x-val ((m <udp_kicker_msg>))
...
(cl:defmethod local_y-val ((m <udp_kicker_msg>))
...
(cl:defmethod local_yaw-val ((m <udp_kicker_msg>))
  ...
  (local_yaw m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <udp_kicker_msg>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <udp_kicker_msg>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<udp_kicker_msg>)))
  "Returns string type for a message object of type '<udp_kicker_msg>"
  "msg_generate/udp_kicker_msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'udp_kicker_msg)))
  "Returns string type for a message object of type 'udp_kicker_msg"
  "msg_generate/udp_kicker_msg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<udp_kicker_msg>)))
  "Returns md5sum for a message object of type '<udp_kicker_msg>"
  "4f5ba7b091b51220f871e749e172c551")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'udp_kicker_msg)))
  "Returns md5sum for a message object of type 'udp_kicker_msg"
  "4f5ba7b091b51220f871e749e172c551")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<udp_kicker_msg>)))
  "Returns full string definition for message of type '<udp_kicker_msg>"
  (cl:format cl:nil "int64 robot_num~%int64 robot_case~%~%int64 local_x~%int64 local_y ~%int64 local_yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'udp_kicker_msg)))
  "Returns full string definition for message of type 'udp_kicker_msg"
  (cl:format cl:nil "int64 robot_num~%int64 robot_case~%~%int64 local_x~%int64 local_y ~%int64 local_yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <udp_kicker_msg>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <udp_kicker_msg>))
  "Converts a ROS message object to a list"
  (cl:list 'udp_kicker_msg
