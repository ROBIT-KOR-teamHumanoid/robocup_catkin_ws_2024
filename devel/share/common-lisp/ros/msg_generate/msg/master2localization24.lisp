...
(cl:defclass <master2localization24> (roslisp-msg-protocol:ros-message)
  ((goal_x
    :reader goal_x
    :initarg :goal_x
    :type cl:integer
...
(cl:defclass master2localization24 (<master2localization24>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <master2localization24>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'master2localization24)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_generate-msg:<master2localization24> is deprecated: use msg_generate-msg:master2localization24 instead.")))

(cl:ensure-generic-function 'goal_x-val :lambda-list '(m))
(cl:defmethod goal_x-val ((m <master2localization24>))
...
(cl:defmethod goal_y-val ((m <master2localization24>))
...
(cl:defmethod target_x-val ((m <master2localization24>))
...
(cl:defmethod target_y-val ((m <master2localization24>))
...
(cl:defmethod robot_allowance_error-val ((m <master2localization24>))
...
(cl:defmethod robot_cali_radius-val ((m <master2localization24>))
  ...
  (robot_cali_radius m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <master2localization24>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <master2localization24>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<master2localization24>)))
  "Returns string type for a message object of type '<master2localization24>"
  "msg_generate/master2localization24")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'master2localization24)))
  "Returns string type for a message object of type 'master2localization24"
  "msg_generate/master2localization24")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<master2localization24>)))
  "Returns md5sum for a message object of type '<master2localization24>"
  "327d5f269dd6e3ee84371d4f5cf9b95e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'master2localization24)))
  "Returns md5sum for a message object of type 'master2localization24"
  "327d5f269dd6e3ee84371d4f5cf9b95e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<master2localization24>)))
  "Returns full string definition for message of type '<master2localization24>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'master2localization24)))
  "Returns full string definition for message of type 'master2localization24"
  (cl:format cl:nil "int64 goal_x~%int64 goal_y~%int64 target_x~%int64 target_y~%int64 robot_allowance_error~%int64 robot_cali_radius~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <master2localization24>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <master2localization24>))
  "Converts a ROS message object to a list"
  (cl:list 'master2localization24
