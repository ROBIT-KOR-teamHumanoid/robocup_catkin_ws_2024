...
(cl:defmethod cl:initialize-instance :after ((m <Mt2Serial_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mt2Serial_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name serial_mcu-msg:<Mt2Serial_msg> is deprecated: use serial_mcu-msg:Mt2Serial_msg instead.")))
