// Generated by gencpp from file msg_generate/robocup_vision24.msg
// DO NOT EDIT!


#ifndef MSG_GENERATE_MESSAGE_ROBOCUP_VISION24_H
#define MSG_GENERATE_MESSAGE_ROBOCUP_VISION24_H
...
struct robocup_vision24_
{
  typedef robocup_vision24_<ContainerAllocator> Type;
  ...
  robocup_vision24_(const ContainerAllocator& _alloc)
    : Ball_cam_X(0)
    , Ball_cam_Y(0)
    , Ball_2d_X(0.0)
    , Ball_2d_Y(0.0)
  ...
  typedef boost::shared_ptr< ::msg_generate::robocup_vision24_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::msg_generate::robocup_vision24_<ContainerAllocator> const> ConstPtr;

}; // struct robocup_vision24_

typedef ::msg_generate::robocup_vision24_<std::allocator<void> > robocup_vision24;

typedef boost::shared_ptr< ::msg_generate::robocup_vision24 > robocup_vision24Ptr;
typedef boost::shared_ptr< ::msg_generate::robocup_vision24 const> robocup_vision24ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::msg_generate::robocup_vision24_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::msg_generate::robocup_vision24_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::msg_generate::robocup_vision24_<ContainerAllocator1> & lhs, const ::msg_generate::robocup_vision24_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::msg_generate::robocup_vision24_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::msg_generate::robocup_vision24_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::msg_generate::robocup_vision24_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::msg_generate::robocup_vision24_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::msg_generate::robocup_vision24_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::msg_generate::robocup_vision24_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::msg_generate::robocup_vision24_<ContainerAllocator> >
{
  ...
  static const char* value(const ::msg_generate::robocup_vision24_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe7c23af0ec42fde2ULL;
  static const uint64_t static_value2 = 0xbe9393d1f1e88db0ULL;
};

template<class ContainerAllocator>
struct DataType< ::msg_generate::robocup_vision24_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::msg_generate::robocup_vision24_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::msg_generate::robocup_vision24_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::msg_generate::robocup_vision24_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::msg_generate::robocup_vision24_<ContainerAllocator>& v)
  {
    s << indent << "Ball_cam_X: ";
...
#endif // MSG_GENERATE_MESSAGE_ROBOCUP_VISION24_H
