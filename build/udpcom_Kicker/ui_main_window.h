...
public:
    ...
    QLabel *label_23;
    QTextEdit *textEdit_READ_4;
    QTextEdit *textEdit_READ_5;
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        label_RNum->setGeometry(QRect(580, 20, 81, 61));
        QFont font1;
        ...
        groupBox->setGeometry(QRect(240, 80, 611, 240));
        QFont font2;
        ...
        textEdit_READ->setGeometry(QRect(10, 60, 121, 171));
        QFont font3;
        font3.setPointSize(11);
        textEdit_READ->setFont(font3);
        textEdit_READ_2 = new QTextEdit(groupBox);
        textEdit_READ_2->setObjectName(QString::fromUtf8("textEdit_READ_2"));
        textEdit_READ_2->setGeometry(QRect(140, 60, 121, 171));
        textEdit_READ_2->setFont(font3);
        ...
        textEdit_READ_3 = new QTextEdit(groupBox);
        textEdit_READ_3->setObjectName(QString::fromUtf8("textEdit_READ_3"));
        textEdit_READ_3->setGeometry(QRect(290, 60, 91, 171));
        textEdit_READ_3->setFont(font3);
        ...
        textEdit_READ_4 = new QTextEdit(groupBox);
        textEdit_READ_4->setObjectName(QString::fromUtf8("textEdit_READ_4"));
        textEdit_READ_4->setGeometry(QRect(390, 60, 91, 171));
        textEdit_READ_4->setFont(font3);
        textEdit_READ_5 = new QTextEdit(groupBox);
        textEdit_READ_5->setObjectName(QString::fromUtf8("textEdit_READ_5"));
        textEdit_READ_5->setGeometry(QRect(490, 60, 111, 171));
        textEdit_READ_5->setFont(font3);
        ...
        groupBox_2->setGeometry(QRect(10, 80, 211, 240));
        QFont font5;
        ...
        textEdit_SEND_2 = new QTextEdit(groupBox_2);
        textEdit_SEND_2->setObjectName(QString::fromUtf8("textEdit_SEND_2"));
        textEdit_SEND_2->setGeometry(QRect(78, 60, 60, 171));
        textEdit_SEND_2->setFont(font3);
        textEdit_SEND = new QTextEdit(groupBox_2);
        textEdit_SEND->setObjectName(QString::fromUtf8("textEdit_SEND"));
        textEdit_SEND->setGeometry(QRect(10, 60, 60, 171));
        textEdit_SEND->setFont(font3);
        textEdit_SEND_3 = new QTextEdit(groupBox_2);
        textEdit_SEND_3->setObjectName(QString::fromUtf8("textEdit_SEND_3"));
        textEdit_SEND_3->setGeometry(QRect(144, 60, 60, 171));
        textEdit_SEND_3->setFont(font3);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        groupBox->setTitle(QApplication::translate("MainWindowDesign", "Read_Helper", 0, QApplication::UnicodeUTF8));
        ...
        groupBox_2->setTitle(QApplication::translate("MainWindowDesign", "Send_Kicker", 0, QApplication::UnicodeUTF8));
        ...
        Receive_2->setText(QApplication::translate("MainWindowDesign", "<html><head/><body><p><span style=\" font-size:26pt; font-style:italic;\">ROBOT_Kicker</span></p><p><br/></p></body></html>", 0, QApplication::UnicodeUTF8));
