...
#ifndef robocup_vision24_yolov4_QNODE_HPP_
#define robocup_vision24_yolov4_QNODE_HPP_
...
public:
    ...
    void masterCallback(const msg_generate::master_2_robocup_vision24::ConstPtr&);
