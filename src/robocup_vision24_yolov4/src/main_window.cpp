...
#include <QMessageBox>
#include <iostream>
#include "../include/robocup_vision24_yolov4/main_window.hpp"
...
msg_generate::robocup_vision24 visionMsg;

extern ros::Publisher vision_feature_Pub;
msg_generate::robocup_vision24_feature vision_feature_Msg;

extern ros::Subscriber masterSub;

namespace robocup_vision24_yolov4 {
...
** Functions
*****************************************************************************/
void robocup_vision24_yolov4::MainWindow::publish_vision_msg()
{
...
void robocup_vision24_yolov4::MainWindow::publish_localization_msg()
{
...
void robocup_vision24_yolov4::MainWindow::filter_100ms()
{
...
void robocup_vision24_yolov4::MainWindow::update(const cv::Mat& img, const cv::Mat& info)
{
...
Mat robocup_vision24_yolov4::MainWindow::Image_processing(const cv::Mat& img)
{
    data.clear();
    ...
    if(save_img_flag)
    {
        ...
        save_img_count += 1;
        char buf[256];
        sprintf(buf, "/home/robit/catkin_ws/src/robocup_vision24_yolov4/img/%s%06d.png", &str_list, save_img_count);
        imwrite(buf, img);
        sprintf(buf, "/home/robit/catkin_ws/src/robocup_vision24_yolov4/img/%s%06d.txt", &str_list, save_img_count);
        ofstream file(buf);
        if(file.is_open())
        {
...
void robocup_vision24_yolov4::MainWindow::setting()
{
...
void robocup_vision24_yolov4::MainWindow::save_hsv()
{
    if(setting_flag != -1)
    {
        ofstream Last_Index_Num_OUT("/home/robit/catkin_ws/src/robocup_vision24_yolov4/resources/HSV/HSV.txt");
...
void robocup_vision24_yolov4::MainWindow::Print_Screen(const cv::Mat& img, const cv::Mat& result_img)
{
    //INIT
...
void robocup_vision24_yolov4::QNode::masterCallback(const msg_generate::master_2_robocup_vision24::ConstPtr &msg)
{
...
void robocup_vision24_yolov4::MainWindow::on_btn_mode_0_clicked()
{
    scan_value = 0;
}
void robocup_vision24_yolov4::MainWindow::on_btn_mode_1_clicked()
{
    scan_value = 2;
}
void robocup_vision24_yolov4::MainWindow::on_btn_mode_2_clicked()
{
    scan_value = 3;
}
void robocup_vision24_yolov4::MainWindow::on_btn_mode_3_clicked()
{
    if(save_img_start){save_img_start = 0; ui.btn_mode_3->setText("SAVE");}
    else{save_img_start = 1; ui.btn_mode_3->setText("STOP");}
}
void robocup_vision24_yolov4::MainWindow::on_radioori_clicked(bool checked)
{
    HSV_flag = 0;
    setting_flag = 0;
}
void robocup_vision24_yolov4::MainWindow::on_radiofield_clicked(bool checked)
{
    HSV_flag = 1;
    setting_flag = 0;
}
void robocup_vision24_yolov4::MainWindow::on_radioline_clicked(bool checked)
{
    HSV_flag = 2;
    setting_flag = 0;
}

void robocup_vision24_yolov4::MainWindow::on_btn_oper_pan_tilt_clicked(bool checked)
{
