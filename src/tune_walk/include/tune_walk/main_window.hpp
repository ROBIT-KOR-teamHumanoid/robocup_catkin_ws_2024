 ...
 *
 * @brief Qt based gui for tune_walk.
 *
 * @date November 2010
 **/
...
#include <QDebug>
#include <QTimer>
#include "/home/robit/catkin_ws/src/tune_walk/include/tune_walk/qcustomplot.hpp"
...
extern ros::Publisher tune2walk_Pub;
...
public:
	...
	~MainWindow();
        ...
        msg_generate::tune2walk msg_tune2walk;
        msg_generate::tune2walk msg_init_tune2walk;
...
//        double Init_Z_Up;
        ...
        int motor_plus_arr[8] = {0,};
        int motor_minus_arr[8] = {0,};

        void Motor_Num_Toss(int Pos_or_Neg, int motor_num);
        void Offset_scroll_reset(int button_flag);

        double offset_past_motor10;
        double offset_past_motor11;
        double offset_past_motor12;
        double offset_past_motor13;
        double offset_past_motor14;
        double offset_past_motor15;
        double offset_past_motor16;
        double offset_past_motor17;
        double offset_past_motor18;
        double offset_past_motor19;
        double offset_past_motor20;
        double offset_past_motor21;
