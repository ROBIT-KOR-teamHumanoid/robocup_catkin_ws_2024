...
public:
    ...
    void eraseTopBlob(const cv::Mat &binaryImg, cv::Mat &imgToModify);
    int findTopYOfLargestBlob(const cv::Mat &binaryImg);
    cv::Rect findLargestBlob(const cv::Mat &binaryImg);
