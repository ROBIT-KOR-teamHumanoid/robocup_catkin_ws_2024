...
#include <sstream>
#include "../include/robocup_vision24_obstacle/qnode.hpp"
...
bool QNode::init() {
    ros::init(init_argc,init_argv,"robocup_vision24_obstacle");
    if ( ! ros::master::check() ) {
        return false;
    }
    ...
    image_sub = it.subscribeCamera("camera/image_raw", 100, &robocup_vision24_obstacle::QNode::imageCallBack, this);
    ...
    hsvPub = n.advertise<msg_generate::HSV>("hsv", 100);
    obsnaviPub = n.advertise<msg_generate::obsnavi>("obsnavi", 100);
