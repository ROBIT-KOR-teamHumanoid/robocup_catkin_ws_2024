...
#include <sstream>
#include "../include/c_robocup_vision23_yolov4/qnode.hpp"
...
bool QNode::init() {
    ros::init(init_argc,init_argv,"c_robocup_vision23_yolov4");
    if ( ! ros::master::check() ) {
        return false;
    }
    ...
    image_sub = it.subscribeCamera("camera/image_raw", 100, &c_robocup_vision23_yolov4::QNode::imageCallBack, this);
