...
#define ROBOT_HEIGHT      598//580//490//475// 505//545// 755.0//544
...
public:
    ...
    int Scan_level[4] ={-50, 0, 50, 0};
    int Scan_timer = 0;
    int Scan_stop_time = 10; //스캔속도 설정
...
private:
    void Tracking_what(double absx, double absy)
    {
        ...
        if(dis > 500)
        {
          ...
          if(angle < -40){Scan_index = 2;}
          else if(angle > 40){Scan_index = 0;}
          else{Scan_index = 1;}
        }
        else{Scan_index = 1;}
