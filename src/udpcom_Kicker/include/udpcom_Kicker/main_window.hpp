/**
 * @file /include/udpcom_Kicker/main_window.hpp
 *
 * @brief Qt based gui for udpcom_Kicker.
 *
 * @date November 2010
 **/
#ifndef udpcom_Kicker_MAIN_WINDOW_H
#define udpcom_Kicker_MAIN_WINDOW_H
...
//        msg_generate::udp_msg_TC_Kicker rb_k;
        ...
        msg_generate::udp_helper_msg rb_h;//helper data order
        msg_generate::udp_kicker_msg rb_k;//kicker data
...
#endif // udpcom_Kicker_MAIN_WINDOW_H
