/**
 * @file /include/udpcom_Kicker/qnode.hpp
 *
...
#ifndef udpcom_Kicker_QNODE_HPP_
#define udpcom_Kicker_QNODE_HPP_
...
public:
	...
	bool init();
        ...
        ros::Subscriber     km2udpsub;
        ros::Publisher      udp2hoderpub;
...
private:
	...
	char** init_argv;
        ...
        void localCallback(const msg_generate::localv2_msg::ConstPtr &msg);
        ...
        void master2udpCallback2(const msg_generate::udp_msg::ConstPtr& msg);

        void master2udpCallback(const msg_generate::udp_kicker_msg::ConstPtr& msg);
};

}  // namespace udpcom_Kicker

#endif /* udpcom_Kicker_QNODE_HPP_ */
