...
#include "../include/ik_walk/zmp_position_control.hpp"
#include "../include/ik_walk/ik_walk.hpp"

using namespace std;

void IK_zmp_pos_control::PID_Zmp_Pitch_Balancing(double Zmp_Input, double Pitch_GP,double Pitch_GI,double Pitch_GD,double Pitch_ELIMIT,double Pitch_OLIMIT,double Pitch_Neg_Target,double Pitch_Pos_Target)
{
...
void IK_zmp_pos_control::PID_Zmp_Roll_Balancing(double Zmp_Input, double Roll_GP, double Roll_GI, double Roll_GD, double Roll_ELIMIT, double Roll_OLIMIT, double Roll_Neg_Target, double Roll_Pos_Target)
{
...
void IK_zmp_pos_control::PID_Zmp_Pitch_Angle_Balancing(double Zmp_Input, double Pitch_Angle_GP,double Pitch_Angle_GI,double Pitch_Angle_GD,double Pitch_Angle_ELIMIT,double Pitch_Angle_OLIMIT,double Pitch_Angle_Neg_Target,double Pitch_Angle_Pos_Target)
{
    ...
    PID_Control_init(&Zmp_Pitch_Angle_Balance, Pitch_Angle_GP, Pitch_Angle_GI, Pitch_Angle_GD, Pitch_Angle_ELIMIT, Pitch_Angle_OLIMIT);
