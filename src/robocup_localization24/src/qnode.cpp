...
#include <sstream>
#include "../include/robocup_localization24/qnode.hpp"
...
bool QNode::init() {
    ros::init(init_argc,init_argv,"robocup_localization24");
    if ( ! ros::master::check() ) {
        return false;
    }
    ...
    vision_feature_Sub = n.subscribe("robocup_vision24_feature", 100, &QNode::visionfeatureCallback, this);
    ...
    masterSub = n.subscribe("master2localization24", 100, &QNode::masterCallback, this);

    //Localization Topic
    localizationPub = n.advertise<msg_generate::robocup_localization24>("robocup_localization24", 100);
