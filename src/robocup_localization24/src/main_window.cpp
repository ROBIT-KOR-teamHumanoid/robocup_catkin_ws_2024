...
#include <iostream>
#include <fstream>
#include "../include/robocup_localization24/main_window.hpp"
...
msg_generate::robocup_localization24 localizationMsg;
    ...
    , qnode(argc,argv)
{
    ...
    QString img_path = "/home/robit/catkin_ws/src/robocup_localization24/resources/Map/2022_RoboCup_Field.png";
...
** Functions
*****************************************************************************/
void robocup_localization24::MainWindow::main()
{
    //INIT
...
void robocup_localization24::MainWindow::sel_ball()
{
...
void robocup_localization24::MainWindow::setting()
{
...
void robocup_localization24::MainWindow::publish_msg()
{
...
void robocup_localization24::MainWindow::Print_Screen() // ui 출력
{
...
void robocup_localization24::MainWindow::mouseReleaseEvent(QMouseEvent * e)
{
...
void robocup_localization24::MainWindow::mouseMoveEvent(QMouseEvent * e)
{
    //PRE CONDITION : mouseEvent, set_robot_flag, set_ball_flag
    //POST CONDITION : robot0.n, ball.n master_target_n,
...
QPolygonF robocup_localization24::MainWindow::create_Print_robot(ROBOT robot)
{
...
int robocup_localization24::MainWindow::cvt_Print_xy(float target)
{
...
void robocup_localization24::QNode::visionfeatureCallback(const msg_generate::robocup_vision24_feature::ConstPtr &msg)
{
...
void robocup_localization24::QNode::imuCallback(const msg_generate::imu_msg::ConstPtr &msg)
{
...
void robocup_localization24::QNode::visionCallback(const msg_generate::robocup_vision24::ConstPtr &msg)
{
    //PRE CONDITION : msg(vision)
...
void robocup_localization24::QNode::coordinateCallback(const msg_generate::ikcoordinate_msg::ConstPtr &msg)
{
...
void robocup_localization24::QNode::gamecontrolCallback(const msg_generate::game_control_data::ConstPtr &msg)
{
...
void robocup_localization24::QNode::udpCallback(const msg_generate::localv2_msg::ConstPtr &msg)
{
...
void robocup_localization24::QNode::masterCallback(const msg_generate::master2localization24::ConstPtr &msg)
{
...
void robocup_localization24::MainWindow::on_btn_free_set_clicked()
{
    //PRE CONDITION : UI
...
void robocup_localization24::MainWindow::on_btn_objects_save_clicked()
{
...
void robocup_localization24::MainWindow::on_btn_set_1_clicked()
{
    //PRE CONDITION : UI
...
void robocup_localization24::MainWindow::on_btn_set_2_clicked()
{
    //PRE CONDITION : UI
    //POST CONDITION : robot0.N, master_target_x
    //purpose : get in시 위치 매크로
...
void robocup_localization24::MainWindow::on_btn_set_3_clicked()
{
    //PRE CONDITION : UI
    //POST CONDITION : robot0.N, master_target_x
    //purpose : get in시 위치 매크로
...
void robocup_localization24::MainWindow::on_btn_set_4_clicked()
{
    //PRE CONDITION : UI
    //POST CONDITION : robot0.N, master_target_x
    //purpose : get in시 위치 매크로
...
void robocup_localization24::MainWindow::on_btn_set_5_clicked()
{
    //PRE CONDITION : UI
    //POST CONDITION : robot0.N, master_target_x
    //purpose : get in시 위치 매크로
...
void robocup_localization24::MainWindow::on_btn_set_6_clicked()
{
    //PRE CONDITION : UI
    //POST CONDITION : robot0.N, master_target_x
    //purpose : get in시 위치 매크로
...
void robocup_localization24::MainWindow::on_btn_set_auto_clicked()
{
    //PRE CONDITION : UI
    //POST CONDITION : robot0.N, master_target_x
...
void robocup_localization24::MainWindow::on_btn_ball_set_clicked()
{
    //PRE CONDITION : UI
...
void robocup_localization24::MainWindow::on_btn_ball_del_clicked()
{
    //PRE CONDITION : UI
...
void robocup_localization24::MainWindow::on_btn_test_clicked()
{
    robot1.x = 0;
    robot1.y = 0;
    robot1.z = 0;
